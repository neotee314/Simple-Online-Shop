...
//
//
//public class StorageUnitComparator3 implements Comparator<StorageUnit> {
//    private final Map<Product, Integer> unfulfilledItems;
//    private final ZipCode clientZipCode;
//
//    public StorageUnitComparator3(Map<Product, Integer> unfulfilledItems, ZipCode clientZipCode) {
